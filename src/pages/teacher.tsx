    ...
    <div className="teacher-page">
      <aside className="sidebar">
        ...
        <div className="sidebar-controls">
          ...
          <button onClick={addTextElement} className="btn-add-text">+ Texto</button>
          <button onClick={handleAddImage} className="btn-add-image">+ Imagem</button>
        </div>
        ...
        <div className="slides-container">
          ...
          <ul className="slides-list">
            ...
            >
              <span onClick={() => setActiveSlide(slide.id)}>Slide {index + 1}</span>
              <button
